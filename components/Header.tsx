      ...
      <div className="w-full px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:1-800-555-MOMS" className="flex items-center text-primary-700 hover:text-primary-800">
              <Phone className="w-5 h-5 mr-1" />
              <span>Call us at 1-800-555-MOMS</span>
            </a>
            <Link
              href="/schedule"
      ...
      {isMobileMenuOpen && (
        <div ref={mobileMenuRef} className="md:hidden bg-white shadow-md">
          <nav className="w-full px-4 py-4">
            ...
            <Link href="/schedule" className="block py-2 text-primary-600 font-semibold" onClick={closeMobileMenu}>
              Book Now
            </Link>
            <Link
              href="/login"
